...
<body class="container">
    <div class="custom-navbar text-center">
        <h2 class="main-heading">Room Management</h2>
    </div>

<a href="room_add.jsp" class="btn btn-success mb-3">Add Room</a>
<a href="index.jsp" class="btn btn-secondary mb-3 float-end">Back to Dashboard</a>

<table class="table table-bordered">
    <thead class="table-dark">
        <tr>
            <th>ID</th><th>Room No.</th><th>Block</th><th>Capacity</th><th>Occupancy</th><th>Type</th><th>Status</th><th>Actions</th>
        </tr>
    </thead>
    <tbody>
<%
...
%>
        <tr>
            ...
            <td>
                <a href="room_add.jsp?id=<%= rs.getInt("room_id") %>" class="btn btn-warning btn-sm">Edit</a>
                <a href="RoomServlet?action=delete&id=<%= rs.getInt("room_id") %>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
<%
        }
