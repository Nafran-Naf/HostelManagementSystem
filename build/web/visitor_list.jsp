...
<body class="container">
    <div class="custom-navbar text-center">
        <h2 class="main-heading">  Visitor Management</h2>
    </div>
<a href="visitor_add.jsp" class="btn btn-success mb-3">Add Visitor</a>
...
%>
        <tr>
            ...
            <td>
                <a href="visitor_add.jsp?id=<%= rs.getInt("visitor_id") %>" class="btn btn-warning btn-sm">Edit</a>
                <a href="VisitorServlet?action=delete&id=<%= rs.getInt("visitor_id") %>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
<%
        }
