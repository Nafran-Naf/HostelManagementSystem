...
<body class="container">
    <div class="custom-navbar text-center">
        <h2 class="main-heading"> Fee Management</h2>
    </div>
<h2> Management</h2>
<a href="fee_add.jsp" class="btn btn-success mb-3">Add Fee</a>
...
<%
    ...
    try {
        ...
        rs = stmt.executeQuery("SELECT * FROM fees");
        while(rs.next()){
%>
        <tr>
            ...
            <td>
                <a href="fee_add.jsp?id=<%= rs.getInt("fee_id") %>" class="btn btn-warning btn-sm">Edit</a>
                <a href="FeeServlet?action=delete&id=<%= rs.getInt("fee_id") %>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-sm">Delete</a>
            </td>
        </tr>
<%
        }
